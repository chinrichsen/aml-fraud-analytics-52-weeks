# Week 4 Monday Exercises — Synthetic Identity Fraud Patterns


This folder contains the hands-on materials for **Week 4 Monday** of the 52-week AML and fraud analytics series.


The theme for this week is **synthetic identity fraud patterns**. The key idea is that synthetic identity cases often look normal in isolation, but become suspicious when you evaluate identity depth, reuse, linkage, and consistency together.
...
> **Synthetic identity fraud is often revealed through patterns, not single fields.**


The goal is not to build a production fraud model. The goal is to create a clear learning artifact that shows how identity quality signals can be translated into a synthetic-risk score and a simple decision tree.
...
## Exercise 1 — Score synthetic identity risk


### Objective


Use the synthetic dataset to calculate a synthetic identity risk score and assign a risk tier.
...
3. Calculate a feature score using explicit formulas.
4. Assign a risk tier such as Low, Medium, or High.
...
`feature_score = identity_depth + reuse_signals + linkage_signals + IP risk`
...
## Exercise 2 — Build the synthetic identity decision tree
...
1. Use the same synthetic identity dataset.
...
This exercise is important because it makes the synthetic identity logic explicit and easy to explain.
...
- Use Exercise 2 to understand how the decision tree supports synthetic identity detection.
